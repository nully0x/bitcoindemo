...
const sendBitcoin = async (sourceAddress, recieverAddress, amount, privateKey) => {
    ...
    console.log(sendBitcoin("ms3pw6XTD4FLq3K6GQ9cQmHofEPnCQd8Qr", "mrxGiK2UKTp25ecmvRCJobG9TkqAVzT28j", 0.0001, "1edff3c742110b1dba9859c9ec9a5fdb202bd63157cec703a179e1a699bb96c5" ))